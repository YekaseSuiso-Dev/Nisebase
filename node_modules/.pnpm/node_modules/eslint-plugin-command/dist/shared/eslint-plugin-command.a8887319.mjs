...
const inlineArrow = {
  ...
  action(ctx) {
    ...
    ctx.report({
      ...
      fix(fixer) {
        return fixer.replaceTextRange(body.range, statement && statement.argument ? ctx.getTextOf(statement.argument) : "undefined");
      }
    });
  }
};
...
export { keepUnique as a, noType as b, toDestructuring as c, toDynamicImport as d, toForEach as e, toForOf as f, toFunction as g, toPromiseAll as h, inlineArrow as i, toStringLiteral as j, keepSorted as k, toTemplateLiteral as l, builtinCommands as m, noShorthand as n, toArrow as t };
