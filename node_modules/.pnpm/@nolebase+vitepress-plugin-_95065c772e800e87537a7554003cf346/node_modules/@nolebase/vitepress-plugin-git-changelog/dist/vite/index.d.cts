...
export { type Commit, type CommitToStringHandler, type CommitToStringsHandler, type Context, GitChangelog, GitChangelogMarkdownSection, type GitChangelogMarkdownSectionOptions, type Locale, type RewritePathsBy, rewritePathsByRewritingExtension };
